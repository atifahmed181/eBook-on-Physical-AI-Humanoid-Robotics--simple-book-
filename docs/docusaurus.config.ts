...
const config: Config = {
  ...
  baseUrl: '/ebook-physical-ai-humanoid-robotics',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'your-organization', // Usually your GitHub org/user name.
  projectName: 'ebook-physical-ai-humanoid-robotics', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Physical AI and Humanoid Robotics Ebook. Built with Docusaurus.`,
    },
    prism: {
